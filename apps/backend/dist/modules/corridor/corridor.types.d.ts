import type { CorridorBlStatus, CorridorContainerStatus, CorridorCustomsStatus, CorridorEmptyReturnStatus, CorridorExceptionStatus, CorridorExceptionType, CorridorInspectionStatus, CorridorInvoiceStatus, CorridorMovementStatus, CorridorPackingListStatus, CorridorPaymentStatus, CorridorServiceMode, CorridorShipmentStatus, CorridorSupportStatus, CorridorTransitDocumentStatus, CorridorTransitDocumentSubtype, CorridorTripStatus } from '../../common/enums';
export type CorridorRole = 'super_admin' | 'executive_supervisor' | 'supplier_agent' | 'supplier_external_agent' | 'origin_coordinator' | 'djibouti_release_agent' | 'djibouti_clearing_agent' | 'corridor_dispatch_agent' | 'dispatch_agent' | 'dry_port_yard_agent' | 'yard_agent' | 'finance_customs_control' | 'finance_agent' | 'document_control_agent' | 'customer_support_agent' | 'customer_user' | 'customer_agent' | 'internal_driver' | 'external_driver' | 'driver' | 'supervisor' | 'admin';
export type CorridorPermission = 'view_own_shipment' | 'view_assigned_shipment' | 'view_all_shipments' | 'create_shipment' | 'edit_shipment_master' | 'close_shipment' | 'create_booking' | 'update_supplier_readiness' | 'record_stuffing' | 'record_seal' | 'record_origin_gate_in' | 'assign_vessel' | 'update_etd_eta_origin' | 'upload_bl' | 'approve_bl_draft' | 'issue_bl_final' | 'upload_invoice' | 'upload_packing_list' | 'upload_transit_doc' | 'upload_release_note' | 'upload_pod' | 'upload_empty_return_receipt' | 'view_all_linked_docs' | 'download_docs' | 'validate_document_checklist' | 'view_cargo_items' | 'create_cargo_items' | 'edit_cargo_items' | 'mark_shortage_damage' | 'mark_inspection_result' | 'record_discharge' | 'update_line_release_status' | 'update_customs_status' | 'update_transit_status' | 'set_free_time_window' | 'mark_gate_out_ready' | 'record_customs_hold' | 'record_customs_release' | 'request_truck_assignment' | 'assign_truck' | 'assign_driver' | 'view_live_tracking' | 'update_eta' | 'record_corridor_checkpoint' | 'record_incident' | 'notify_customer' | 'record_dry_port_arrival' | 'record_unload' | 'assign_storage_location' | 'mark_delivery_complete' | 'record_pod' | 'confirm_customer_receipt' | 'release_empty_container' | 'record_empty_return' | 'view_invoice_status' | 'issue_invoice' | 'record_payment' | 'issue_receipt' | 'view_duty_tax_summary' | 'mark_duty_tax_paid' | 'gate_release_on_payment' | 'clear_finance_block' | 'create_ticket' | 'reply_ticket' | 'escalate_ticket' | 'view_support_history' | 'mark_ocean_handoff_ready' | 'push_to_dispatch' | 'push_to_yard' | 'close_shipment_cycle' | 'override_stage_owner' | 'reassign_stage_owner' | 'view_customer_summary' | 'view_internal_finance' | 'view_release_risk' | 'view_yard_closure' | 'view_assigned_trip' | 'view_transit_pack' | 'view_item_summary' | 'view_docs_for_trip' | 'confirm_seal_intact' | 'record_checkpoint_note' | 'upload_checkpoint_photo' | 'record_gate_in_out' | 'report_customs_hold' | 'report_shortage_damage' | 'confirm_arrival' | 'confirm_unload' | 'confirm_empty_return';
...
export type CorridorVisibilityScope = 'internal_only' | 'customer_visible' | 'driver_visible' | 'supplier_visible' | 'djibouti_visible' | 'yard_visible' | 'finance_visible' | 'supervisor_visible';
export type CorridorNormalizedShipmentStage = 'booking_quote' | 'origin_preparation' | 'ocean_in_transit' | 'djibouti_release' | 'transitor_clearance' | 'inland_dispatch' | 'inland_arrival' | 'yard_processing' | 'delivery_pod' | 'empty_return' | 'closed';
export type CorridorNormalizedContainerStatus = 'pending' | 'stuffed' | 'gated_in' | 'discharged' | 'release_pending' | 'gate_out_ready' | 'in_transit' | 'arrived' | 'unloaded' | 'empty_released' | 'empty_return_in_progress' | 'empty_returned' | 'closed';
export type CorridorNormalizedTripStatus = 'awaiting_assignment' | 'assigned' | 'ready_to_depart' | 'departed' | 'in_transit' | 'checkpoint_hold' | 'delayed' | 'arrived_inland' | 'handed_to_yard' | 'closed';
export type CorridorNormalizedDocumentStatus = 'missing' | 'uploaded' | 'under_review' | 'approved' | 'rejected';
export type CorridorNormalizedExceptionStatus = 'open' | 'acknowledged' | 'in_progress' | 'resolved' | 'dismissed';
export type CorridorDocumentType = 'commercial_invoice' | 'packing_list' | 'bl_draft' | 'final_bl' | 'export_permit' | 'customs_note' | 'transit_document' | 'release_note' | 'pod' | 'receipt' | 'stuffing_photo' | 'seal_photo' | 'unload_photo' | 'return_receipt' | 'special_handling_note';
export type CorridorWorkspaceKey = 'booking_quote' | 'supplier' | 'djibouti' | 'transitor' | 'dispatch' | 'yard' | 'finance';
export type CorridorBookingRequestSource = 'customer' | 'supplier' | 'internal' | 'port_agent' | 'admin';
export type CorridorQuoteStatus = 'quote_requested' | 'quote_under_review' | 'quote_sent' | 'quote_accepted' | 'quote_rejected' | 'quote_revision_requested' | 'booking_created' | 'assigned_to_origin';
export type CorridorContainerMovementCode = 'full_out_djibouti' | 'full_in_dry_port' | 'full_out_customer' | 'empty_in_dry_port' | 'empty_out_dry_port' | 'empty_in_djibouti';
